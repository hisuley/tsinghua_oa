                ...
                <div class="index-botton-container" style="height:400px;overflow:hidden;">
                    ...
                    <div class="index-button-box">
                        ...
                        <a href="<?php echo $this->createUrl('leave/list', array('type'=>Leave::TYPE_NORMAL, 'action'=>'review')); ?>" class="index-common-button index-button-short index-button-orange	"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/bigicons//bigmews.png" alt=""><span>请假审批</span></a>
                        <a href="<?php echo $this->createUrl('leave/list', array('type'=>Leave::TYPE_CHANGE, 'action'=>'review')); ?>" class="index-common-button index-button-short index-button-orange"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/bigicons//bigcuphand.png" alt=""><span>调休审批</span></a>
