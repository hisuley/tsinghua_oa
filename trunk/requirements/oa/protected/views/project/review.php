<!--中间录入部分-->
					<div class="substance">
						...
						<div class="leftside" >
							...
							<div >
								<div class="tittle2">
									<h2>城乡住房与社区研究中心2013年项目合同执行情况统计表</h2>
								</div>
								<div class="check_down check_down1 check_downs">
								<a href="#" onclick="">
								2013/06<img id="down" src="<?php echo Yii::app()->request->baseUrl; ?>/images/elements/down.png"></a>
								<!--下拉单
								<div>
									<ul class="down_list">
										<li>项目名称</li>
								...
								<a style="padding-left:235px;margin-top:-55px ;display:block;margin-bottom:20px;text-decoration:none;color:#032e3d;" href="#">
									<img  src="<?php echo Yii::app()->request->baseUrl; ?>/images/elements/checkedorange.png">
									手动排序
								</a>	
							</div>
